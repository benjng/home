...
const mainBody = {
  ...
  gradientColors: "#3D3B3C, #000000, #250000",
  firstName: "Benjamin",
  middleName: "",
  lastName: "Ng",
  message: " Passionate about changing the world with arts and games. ",
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/benjng",
    },
    // {
    //   image: "fa-facebook",
...
const repos = {
  ...
  gitHubUsername: "benjng", //i.e."johnDoe12Gh"
  reposLength: 4,
  specificRepos: [],
};
...
const getInTouch = {
  ...
  message:
    "I'm currently looking for full-time Software Engineering or Game Developing opportunities! Please feel free to email me at",
  email: "ppbenng@gmail.com",
};
